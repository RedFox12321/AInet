        ...
        <div class="w-full max-w-md p-8 space-y-8 bg-stone-900 border-black rounded-lg shadow-md">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mt-4">
                    ...
                    <x-auth.text-input id="email" class="block mt-1 w-full" type="email" name="email"
                ...
                <div class="mt-4">
                    ...
                    <x-auth.text-input id="password_confirmation" class="block mt-1 w-full" type="password"
