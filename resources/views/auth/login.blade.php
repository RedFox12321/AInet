    ...
    <div class="w-full max-w-md p-8 space-y-8 bg-stone-900 border-black rounded-lg shadow-md">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4">
                ...
                <x-auth.text-input id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="current-password" />
            ...
            <div class="block mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    <input id="remember_me" type="checkbox" class="rounded bg-stone-700 border-gray-300 text-rose-600 shadow-sm focus:ring-rose-900" name="remember">
