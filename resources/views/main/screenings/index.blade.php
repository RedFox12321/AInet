    ...
    <div class="flex flex-wrap justify-around">
        ...
        <div class="flex flex-col items-center mt-10">
            ...
            <div class="h-max w-max flex fit-content justify-left m-10">
                ...
                <x-screenings.filter-card :filterAction="route('screenings.index')" :resetUrl="route('screenings.index')" :title="old('search', $filterByTitleSynopsis)" :theater="old('theater', $filterByTheater)"
                    :genre="old('genre', $filterByGenre)" :date="old('date', $filterByDate)" :genres="$genres->pluck('name', 'code')->toArray()" :theaters="$theaters->pluck('name', 'name')->toArray()" />
